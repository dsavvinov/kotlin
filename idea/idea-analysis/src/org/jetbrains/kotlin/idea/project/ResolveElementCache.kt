...
class ResolveElementCache(
    ...
    private fun performElementAdditionalResolve(
        ...
        ControlFlowInformationProvider(resolveElement, controlFlowTrace, resolveElement.languageVersionSettings, resolveSession.typeResolver).checkDeclaration()
    ...
    private fun propertyAdditionalResolve(resolveSession: ResolveSession, property: KtProperty,
        ...
        for (accessor in property.accessors) {
            ControlFlowInformationProvider(accessor, trace, accessor.languageVersionSettings, resolveSession.typeResolver).checkDeclaration()
        }
