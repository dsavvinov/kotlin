...
public inline fun @receiver:kotlin.internal.EqualsCondition(kotlin.internal.ConstantValue.NULL) CharSequence?.isNullOrEmpty(): Boolean = this == null || this.length == 0
...
@kotlin.internal.InlineOnly
@kotlin.internal.Returns(kotlin.internal.ConstantValue.TRUE)
public inline fun @receiver:kotlin.internal.EqualsCondition(kotlin.internal.ConstantValue.NULL) CharSequence?.isNullOrBlank(): Boolean = this == null || this.isBlank()
